...
public class ScholarNodeSecondaryIndex extends ScholarNode {
	...
	public void addChild (Integer index, ScholarNode child) { this.children.add(index, child); }

	public void addJournal (Integer index, String journal) { this.journals.add(index, journal); }

	public ArrayList<String> getJournals() { return this.journals; }
